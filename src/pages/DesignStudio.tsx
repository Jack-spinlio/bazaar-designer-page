...
import { Pencil, Puzzle, FileSpreadsheet, Bookmark, FrameIcon, Battery, Disc, Grip, Lightbulb, Shield, Link, Footprints, Cog, Gamepad, Utensils, ChevronRight } from "lucide-react";
                    ...
                    <TableCell className="w-[40px]">
                      <div className="flex items-center">
                        ...
                        <div className="w-10 h-10 bg-gray-100 rounded-md flex items-center justify-center overflow-hidden">
                          ...
                          <img src={component.image} alt={component.component} className="w-7 h-7 object-contain opacity-40" />
                        </div>
                      </div>
                    </TableCell>
