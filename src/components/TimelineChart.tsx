    ...
    <ScrollArea className="h-full bg-white">
      <div className="flex flex-col p-6">
        ...
        <div className="relative flex-1">
          ...
          {/* Total timeline row - a true continuous bar that spans the full width */}
          ...
          <div className="space-y-1">
            {sortedComponents.map(component => (
              <div key={component.id} className="flex items-center h-10">
                ...
                {/* Timeline bar - with a true "stretch to the end" approach */}
                <div className="flex-1 relative h-full">
                  <div 
                    ...
                    style={{
                      ...
                      width: `calc(100% - ${getWeekPosition(component.startWeek)})`,
                      minWidth: '50px'
                    }} 
                  >
